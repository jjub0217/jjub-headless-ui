import { createContext, useState, useId, useCallback, useRef, useEffect, useContext } from 'react';
...
function Root({
  ...
  return /* @__PURE__ */ jsx(TabsContext.Provider, { value: { value, onValueChange: handleValueChange, orientation, activationMode, baseId }, children: /* @__PURE__ */ jsx("div", { className, "data-orientation": orientation, children }) });
}
...
function Title({ children, className, ...props }) {
  ...
  return /* @__PURE__ */ jsx("h2", { id: titleId, className, ...props, children });
}
function Description({ children, className, ...props }) {
  const { descriptionId } = useDialogContext();
  return /* @__PURE__ */ jsx("p", { id: descriptionId, className, ...props, children });
}
...
function Value({ placeholder, children }) {
  ...
  if (!value && placeholder) {
    return /* @__PURE__ */ jsx("span", { "data-placeholder": "", children: placeholder });
  }
  return /* @__PURE__ */ jsx("span", { children: children ?? value });
}
...
function Root5(props) {
  ...
  return /* @__PURE__ */ jsx(AccordionContext.Provider, { value: { value, onToggle, type, collapsible, orientation, baseId }, children: /* @__PURE__ */ jsx("div", { className, "data-orientation": orientation, children }) });
}
...
function Header({ children, className, ...headerProps }) {
  return /* @__PURE__ */ jsx("h3", { className, ...headerProps, children });
}
...
function Content4({ forceMount = false, children, className, style, ...contentProps }) {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      ...contentProps,
      children: /* @__PURE__ */ jsx("div", { style: { overflow: "hidden", minHeight: 0 }, children })
    }
  );
}
var Accordion = {
...
function Title3({ children, className, ...props }) {
  return /* @__PURE__ */ jsx("p", { "data-toast-title": "", className, ...props, children });
}
function Description3({ children, className, ...props }) {
  return /* @__PURE__ */ jsx("p", { "data-toast-description": "", className, ...props, children });
}
  ...
  return createPortal(
    /* @__PURE__ */ jsx(
      "ol",
      {
        ...
        className,
        ...props,
        children: toasts.map((toast) => /* @__PURE__ */ jsxs(Root7, { toastId: toast.id, duration: toast.duration, "data-variant": toast.variant, children: [
          /* @__PURE__ */ jsxs("div", { children: [
            toast.title && /* @__PURE__ */ jsx(Title3, { children: toast.title }),
            toast.description && /* @__PURE__ */ jsx(Description3, { children: toast.description })
          ] }),
          /* @__PURE__ */ jsx(Close2, { toastId: toast.id })
        ] }, toast.id))
      }
    ),
...
var TagInputContext = createContext(null);
...
function Root11({
  ...
  return /* @__PURE__ */ jsx(TagInputContext.Provider, { value: { tags, addTag, removeTag, removeLastTag, inputId, maxTags, disabled }, children: /* @__PURE__ */ jsx(
    "div",
    {
      className,
      "data-disabled": disabled ? "" : void 0,
...
function Root12({
  ...
  return /* @__PURE__ */ jsx(CheckboxGroupContext.Provider, { value: { value, onToggle, disabled }, children: /* @__PURE__ */ jsx(
    "div",
    {
      role: "group",
...
function Indicator2({ children, className, ...props }) {
  return /* @__PURE__ */ jsx("span", { "aria-hidden": "true", className, ...props, children });
}
var CheckboxGroup = {
  Root: Root12,
  Option: Option3,
...
function Root13({ value = null, max = 100, children, className, ...props }) {
  ...
  return /* @__PURE__ */ jsx(ProgressContext.Provider, { value: { value: clampedValue, max, percentage }, children: /* @__PURE__ */ jsx(
    "div",
    {
      role: "progressbar",
...
function Root15({
  ...
  return /* @__PURE__ */ jsx(FileUploadContext.Provider, { value: { files, addFiles, removeFile, inputId, multiple, accept, disabled, isDragging, setIsDragging }, children: /* @__PURE__ */ jsx(
    "div",
    {
      className,
      "data-disabled": disabled ? "" : void 0,
...
function Preview({ children, className, ...props }) {
  return /* @__PURE__ */ jsx("ul", { role: "list", "aria-label": "\uC5C5\uB85C\uB4DC\uB41C \uD30C\uC77C \uBAA9\uB85D", className, ...props, children });
}
...
function Root16({ children, className, ...props }) {
  ...
  return /* @__PURE__ */ jsx(AvatarContext.Provider, { value: { imageStatus, setImageStatus }, children: /* @__PURE__ */ jsx(
    "span",
    {
      role: "img",
...
function ToggleGroup({
  ...
  return /* @__PURE__ */ jsx(ToggleGroupContext.Provider, { value: { value, onValueChange: handleValueChange }, children: /* @__PURE__ */ jsx(
    "div",
    {
      role: "group",
      "aria-label": ariaLabel,
...
function Root19({
  ...
  return /* @__PURE__ */ jsx(NavigationMenuContext.Provider, { value: { orientation }, children: /* @__PURE__ */ jsx(
    "nav",
    {
      role: "navigation",
      "aria-label": ariaLabel,
...
function Item4({ children, className, ...props }) {
  return /* @__PURE__ */ jsx("li", { className, ...props, children });
}
