...
import { C as definePreviewAddon10 } from "./components-DZ0xudpx.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-C_PLRnNl.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-eluWELhb.js");
